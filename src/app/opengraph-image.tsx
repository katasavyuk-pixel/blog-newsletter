...
// "Kata Pro" red/black premium: cold black + a controlled deep-red halo,
// chrome/silver wordmark, cold-white headline.
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ display: "flex", fontSize: 28, color: "#d7212a", maxWidth: "940px" }}>
